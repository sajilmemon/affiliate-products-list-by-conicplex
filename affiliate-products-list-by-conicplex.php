...
/* Plugin Activation & Deactivation */
	...
	function aplbcp_activate(){
		...
		$create_tb_sql="CREATE TABLE $table(
            ...
            aplbcp_button_hover_shadow VARCHAR(30) NOT NULL, PRIMARY KEY (`aplbcp_setting_id`)) $charset_collate;";
		...
		('#ff5900', '#FFFFFF','25','200','#ff5900','20','14','#ff5900','#FFFFFF','2','#ff5900','5','#FFFFFF','#ff5900','5','#ff5900','5px 10px #ff5900')");
